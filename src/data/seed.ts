export const companyProfile = {
  ...
  positioning:
    "AI-native healthcare interoperability infrastructure with deterministic workflows and advisory AI.",
};
...
export const investors = [
  ...
  },
  {
    ...
    interest: "Prior auth automation",
  },
];
...
export const activity = [
  ...
  {
    event: "Follow-up recommended",
    detail: "Send security roadmap and pilot validation summary",
    time: "Yesterday",
  },
];
